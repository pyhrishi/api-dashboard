...
export default function ApiLandingPage() {
  ...
  return (
    <div className="bg-ink min-h-screen text-white font-sans overflow-hidden selection:bg-teal selection:text-ink">
      ...
      <main className="relative z-10">
        ...
        <section className="relative px-6 pt-24 pb-28 mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div 
              ...
              className="text-left"
            >
              <motion.div variants={fadeUp} className="inline-flex items-center gap-2.5 rounded-full border border-white/12 bg-white/5 px-4 py-2 text-[13px] font-bold tracking-widest text-teal mb-8 uppercase">
              ...
              <motion.p variants={fadeUp} className="text-[18px] leading-[1.65] text-white/65 max-w-lg mb-10">
              ...
              <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <Link href="/docs" className="inline-flex items-center justify-center gap-2 rounded-full bg-white/5 border border-white/10 px-8 py-4 text-[16px] font-bold text-white transition-all duration-300 hover:bg-white/10 w-full sm:w-auto">
                  Read the Docs
                </Link>
              </motion.div>
              
              <motion.div variants={fadeUp} className="mt-10 flex items-center gap-6 text-sm font-medium text-white/40">
        ...
        <section className="border-t border-white/10 bg-white/5 py-24">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-extrabold text-white">The Dual-Engine Advantage</h2>
              <p className="mt-4 text-white/60 max-w-2xl mx-auto">Our infrastructure queries two separate engines and automatically resolves conflicts using strict registry precedence.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 relative">
              ...
              <div className="glass-inner rounded-3xl p-8 relative overflow-hidden group">
                <div className="absolute top-0 left-0 w-1.5 h-full bg-white/20 transition-colors group-hover:bg-white/40" />
                <h3 className="text-2xl font-bold text-white mb-4">Lookup Engine</h3>
                <p className="text-white/60 mb-6">Massive scale entity resolution relying on public web footprints, LinkedIn data, and historic contact databases.</p>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3 text-sm text-white/70"><Check className="w-4 h-4 text-teal" /> 400M+ Contact Records</li>
                  <li className="flex items-center gap-3 text-sm text-white/70"><Check className="w-4 h-4 text-teal" /> Real-time Social Enrichment</li>
                  <li className="flex items-center gap-3 text-sm text-white/70"><Check className="w-4 h-4 text-teal" /> Historic Phone/Email mapping</li>
                </ul>
              </div>

              <div className="glass-inner rounded-3xl p-8 relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-1.5 h-full bg-teal transition-colors group-hover:bg-teal-ice" />
                <h3 className="text-2xl font-bold text-white mb-4">IDS Engine</h3>
                <p className="text-white/60 mb-6">Deterministic intelligence sourced exclusively from the Ministry of Corporate Affairs (MCA) and government registries.</p>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3 text-sm text-white/70"><Check className="w-4 h-4 text-teal" /> CIN & DIN Resolution</li>
                  <li className="flex items-center gap-3 text-sm text-white/70"><Check className="w-4 h-4 text-teal" /> Legal Entity Structures</li>
                  <li className="flex items-center gap-3 text-sm text-white/70"><Check className="w-4 h-4 text-teal" /> Audited Financial Overlays</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 relative">
          <div className="max-w-7xl mx-auto px-6">
            <div className="mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-extrabold text-white">Everything your stack needs</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {endpoints.map((endpoint, i) => (
                <motion.div 
                  ...
                  key={endpoint.title} 
                  className="glass-inner rounded-2xl p-6 hover:-translate-y-1 transition-all duration-300 group flex flex-col justify-between hover:border-teal/50"
                >
                  <div>
                    <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 text-teal">
                      {endpoint.icon}
                    </div>
                    <h3 className="text-lg font-bold text-white mb-2">{endpoint.title}</h3>
                    <p className="text-white/50 text-sm leading-relaxed">{endpoint.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        <section className="py-24 border-t border-white/10 relative z-20">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <p className="mb-4 text-[13px] font-semibold uppercase tracking-[0.2em] text-teal">Developer Experience</p>
              <h2 className="text-3xl md:text-4xl font-display font-extrabold text-white">Integrate in minutes.</h2>
              <p className="mt-4 text-white/60 max-w-2xl mx-auto">Native SDKs and standard REST APIs. Copy, paste, and ship to production today.</p>
            </div>
        ...
        {/* PRICING */}
        <section className="py-24 border-t border-white/10 bg-gradient-to-b from-white/5 to-transparent relative z-10">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-display font-extrabold text-white">Simple, Usage-Based Economics</h2>
              <p className="mt-4 text-white/60 max-w-xl mx-auto">Credits are deducted only on successful `200 OK` resolutions. Cached hits cost 0 credits.</p>
            </div>
            
            <div className="grid md:grid-cols-3 gap-8">
              {pricingTiers.map((tier) => (
                <div key={tier.name} className="glass-inner rounded-3xl p-8 flex flex-col items-center text-center hover:border-teal/30 transition-colors">
                  ...
                  <button className="w-full py-3 rounded-full border border-white/20 text-white font-bold hover:bg-white hover:text-ink transition-colors">
                    Get Started
                  </button>
                </div>
              ))}
            ...
            <div className="mt-8 p-8 glass rounded-2xl flex justify-between items-center flex-col sm:flex-row gap-6 border-gradient">
              <div>
                <p className="font-bold text-white mb-1">Volume Pricing</p>
                <p className="text-sm text-white/60">Need high-volume orchestration for enterprise workloads?</p>
              </div>
        ...
        <section className="py-24 border-t border-white/10 relative z-10">
          <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-display font-extrabold text-white">Technical FAQ</h2>
              <p className="mt-4 text-white/60">Common questions from engineering and security teams.</p>
            </div>
            
            <div className="space-y-6">
              <div className="glass-inner rounded-2xl p-6 md:p-8 border border-white/10 hover:border-white/20 transition-colors">
                <h3 className="text-lg font-bold text-white mb-3">What are your SLAs and expected latencies?</h3>
              ...
              <div className="glass-inner rounded-2xl p-6 md:p-8 border border-white/10 hover:border-white/20 transition-colors">
                <h3 className="text-lg font-bold text-white mb-3">How do you ensure data compliance (DPDP, GDPR)?</h3>
                <p className="text-white/70 text-sm leading-relaxed">
              ...
              <div className="glass-inner rounded-2xl p-6 md:p-8 border border-white/10 hover:border-white/20 transition-colors">
                <h3 className="text-lg font-bold text-white mb-3">Is the API idempotent?</h3>
                <p className="text-white/70 text-sm leading-relaxed">
      ...
      <footer className="bg-ink border-t border-white/10 py-16 text-center">
        <div className="max-w-7xl mx-auto px-6 flex flex-col items-center">
          <ShieldCheck className="w-10 h-10 text-teal/40 mb-6" />
          <p className="text-white/40 max-w-3xl text-sm leading-relaxed font-medium">
          ...
          <div className="mt-8 flex items-center gap-4 text-sm font-semibold text-white/30">
